...
public class AddShopOnRoutesTab extends Fragment {

    private Toolbar toolbar;
    private TabLayout tabLayout;
    private ViewPager viewPager;

    public AddShopOnRoutesTab() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new /*ShowRouteDetailsFragment()*/AdminDetailsFragment(), "SHOW ROUTE DETAILS");
        adapter.addFragment(new /*AddRouteForShopsFragment()*/AdminDetailsFragment(), "ADD ROUTE");
